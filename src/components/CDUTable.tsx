...
interface IEnhancedTableHeadProps {
  ...
  onSelectAllClick(event: React.ChangeEvent<HTMLInputElement>, checked: boolean): any;
  order: any;
  orderBy: any;
  numSelected: number;
  rowCount: number;
...
interface IEnhancedTableToolbarProps extends WithStyles<typeof styles> {}

let EnhancedTableToolbar = (props: IEnhancedTableToolbarProps) => {
