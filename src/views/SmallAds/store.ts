  ...
  @action public fetchItems(): void {
    this.ads = [
      ...
      },
      {
        ...
        name: " Capacete Rosa",
        foundBy: "Administração - gestor - gestão",
        createdBy: "Administração - gestor - gestão",
        creationDate: new Date(),
        status: "",
      },
      {
